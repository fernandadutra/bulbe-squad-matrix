...
D01. A alta inadimplência da primeira fatura, devido ao tempo de implementação da primeira fatura (3 meses após a adesão).
  Fala 1: "Temos um prazo médio de 90 dias de implementação com a CEMIG"
  Fala 2:"Recebemos muitos relatos de clientes que não receberam a conta devido ao tempo de implementação que pode chergar a 4 meses"
